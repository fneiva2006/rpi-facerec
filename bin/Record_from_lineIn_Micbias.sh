...
# +8dB input PGA gain
amixer $1 -Dhw:sndrpiwsp cset name='IN3L Volume' 80
amixer $1 -Dhw:sndrpiwsp cset name='IN3R Volume' 80

# Enable MICBIAS for Line Input
amixer $1 -Dhw:sndrpiwsp cset name='Line Input Switch' on
...
amixer $1 -Dhw:sndrpiwsp cset name='LHPF2 Input 1' IN3L
